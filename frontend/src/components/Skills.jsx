...
//       title: 'Tech Stacks',
//       icon: '📚',
//       skills: ['MERN Stack', 'PERN Stack', 'Full Stack Development', 'REST API Design', 'Web Architecture']
//     }
//   };
...
//               <div
//                 key={index}
//                 className="card p-6 text-center cursor-pointer group hover:scale-110 transition-transform duration-300"
...
//                 </div>
//                 <h3 className="text-lg font-semibold text-cyan-400 group-hover:text-white transition-colors duration-300">
//                   {skill}
//                 </h3>
//               </div>
//             ))}
...
//         {/* Proficiency Info */}
//         <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
//           <div className="card p-6 border-l-4 border-cyan-500">
//             <h4 className="text-lg font-semibold text-cyan-400 mb-2">Primary Skills</h4>
//             <p className="text-gray-300 text-sm">MERN Stack, PERN Stack, Full-stack development with modern JavaScript and Python</p>
//           </div>
//           <div className="card p-6 border-l-4 border-blue-500">
//             <h4 className="text-lg font-semibold text-blue-400 mb-2">Learning & Growing</h4>
//             <p className="text-gray-300 text-sm">Advanced system design, cloud deployment, and backend optimization</p>
//           </div>
//         </div>
//       </div>
//     </section>
